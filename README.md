...
- để sử dụng Google Developer Console ta thực hiện theo các bước sau
    ...
    <img src="https://github.com/hienqp/Ngay046-ConsoleCloudGoogle-YoutubeAPI/blob/main/1_xin_quyen_internet.png">
	- download library Youtube Android Player API
    <img src="https://github.com/hienqp/Ngay046-ConsoleCloudGoogle-YoutubeAPI/blob/main/2_download_youtube_android_player_api.png">
	- giải nén folder chứa YoutubeAndroidPlayer API, sau đó copy file
    <img src="https://github.com/hienqp/Ngay046-ConsoleCloudGoogle-YoutubeAPI/blob/main/3_giai_nen_copy_file_jar.png">
	- paste file jar vào folder libs của Project ở View Project
    <img src="https://github.com/hienqp/Ngay046-ConsoleCloudGoogle-YoutubeAPI/blob/main/4_paste_file_jar_vao_folder_libs.png">
	- chuột phải vào file jar chọn Add As Library để add library này vào module:app
    <img src="https://github.com/hienqp/Ngay046-ConsoleCloudGoogle-YoutubeAPI/blob/main/5_add_as_library.png">
	- kết quả sau khi add as library
    <img src="https://github.com/hienqp/Ngay046-ConsoleCloudGoogle-YoutubeAPI/blob/main/6_kq_sau_khi_add_as_library.png">
    ...
    <img src="https://github.com/hienqp/Ngay046-ConsoleCloudGoogle-YoutubeAPI/blob/main/7_login_google.png">
	- click chọn country và các term của Google API, ta sẽ vào giao diện DASHBOARD của Google Developer Console
    <img src="https://github.com/hienqp/Ngay046-ConsoleCloudGoogle-YoutubeAPI/blob/main/8_check_terms.png">
	- copy package name của Project
    <img src="https://github.com/hienqp/Ngay046-ConsoleCloudGoogle-YoutubeAPI/blob/main/9_copy_package_name_of_project.png">
	- ở DashBoard của GDC click SELECT A PROJECT
    <img src="https://github.com/hienqp/Ngay046-ConsoleCloudGoogle-YoutubeAPI/blob/main/10_click_select_a_project_on_dashboard_of_google_developer_console.png">
	- cửa sổ quản lý Project hiện lên, chọn NEW PROJECT
    <img src="https://github.com/hienqp/Ngay046-ConsoleCloudGoogle-YoutubeAPI/blob/main/11_click_new_project.png">
    ...
    <img src="https://github.com/hienqp/Ngay046-ConsoleCloudGoogle-YoutubeAPI/blob/main/12_paste_package_name_project_into_name_project_field.png">
	- DashBoard hiển thị Project GDC vừa CREATE (hoặc ta có thể tự click chọn Project), click chọn mục CREDENTIALS
    <img src="https://github.com/hienqp/Ngay046-ConsoleCloudGoogle-YoutubeAPI/blob/main/13_after_create_project_gdc.png">
    ...
    <img src="https://github.com/hienqp/Ngay046-ConsoleCloudGoogle-YoutubeAPI/blob/main/14_create_credentials.png">

    <img src="https://github.com/hienqp/Ngay046-ConsoleCloudGoogle-YoutubeAPI/blob/main/15_content_api_key.png">
	- tiến hành edit API KEY
    <img src="https://github.com/hienqp/Ngay046-ConsoleCloudGoogle-YoutubeAPI/blob/main/16_edit_api_key.png">
	- Application restrictions chọn Android apps
    <img src="https://github.com/hienqp/Ngay046-ConsoleCloudGoogle-YoutubeAPI/blob/main/17_application_restrictioins_select_android.png">
	- mục Restrict usage to your Android Apps click ADD
    <img src="https://github.com/hienqp/Ngay046-ConsoleCloudGoogle-YoutubeAPI/blob/main/17_1_Restrict_usage_to_your_Android_Apps_click_ADD.png">
	- copy full package name app trong Gradle Script module app
    <img src="https://github.com/hienqp/Ngay046-ConsoleCloudGoogle-YoutubeAPI/blob/main/18_copy_full_package_name_app.png">
	- paste full package name app
    <img src="https://github.com/hienqp/Ngay046-ConsoleCloudGoogle-YoutubeAPI/blob/main/19_paste_full_package_name.png">
	- mở Gradle tab trong Android Studio, double click signingReport
    <img src="https://github.com/hienqp/Ngay046-ConsoleCloudGoogle-YoutubeAPI/blob/main/20_run_signingReport_inGradle_tab.png">
	- copy SHA1 Key
    <img src="https://github.com/hienqp/Ngay046-ConsoleCloudGoogle-YoutubeAPI/blob/main/21_copy_SHA1_key.png">
    - để mở được Gradle Task List, ta bỏ chọn __Do not build Gradle task list during Gradle sync__ sau đó apply OK
    <img src="https://github.com/hienqp/Ngay046-ConsoleCloudGoogle-YoutubeAPI/blob/main/21_1_turn_on_Gradle_task_list.png">
	- paste SHA1 Key vào cửa sổ EDIT API KEY, sau đó click DONE
    <img src="https://github.com/hienqp/Ngay046-ConsoleCloudGoogle-YoutubeAPI/blob/main/22_paste_SHA1_key_on_GDC.png">
	- click SAVE để lưu lại quá trình EDIT API KEY của project trên GDC, quay trở lại cửa sổ Credentials
    <img src="https://github.com/hienqp/Ngay046-ConsoleCloudGoogle-YoutubeAPI/blob/main/23_click_SAVE_to_comple_editting_API_KEY.png">
	- click SHOW API KEY và copy API KEY
    <img src="https://github.com/hienqp/Ngay046-ConsoleCloudGoogle-YoutubeAPI/blob/main/24_click_SHOW_KEY_and_copy_API_KEY.png">
	- trong Project App, tạo class __config__ chứa thông tin của API Key
    <img src="https://github.com/hienqp/Ngay046-ConsoleCloudGoogle-YoutubeAPI/blob/main/25_create_class_contain_api_key.png">
	- quay trở lại GDC, ở giao diện API & Service, click chọn mục Library
    <img src="https://github.com/hienqp/Ngay046-ConsoleCloudGoogle-YoutubeAPI/blob/main/26_goto_library.png">
	- trong list các Library, chọn Youtube Data API V3
    <img src="https://github.com/hienqp/Ngay046-ConsoleCloudGoogle-YoutubeAPI/blob/main/27_goto_youtube_api_v3.png">
	- click ENABLE để kích hoạt Youtube Data API V3
    <img src="https://github.com/hienqp/Ngay046-ConsoleCloudGoogle-YoutubeAPI/blob/main/28_click_enable.png">
